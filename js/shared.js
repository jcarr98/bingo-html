...
async function validateUser(action=null) {
  ...
  const fetchStr = action == null ? `https://bingo-generator-backend-vai2syswsq-ue.a.run.app/auth/validate?accessToken=${user.token}` : `https://bingo-generator-backend-vai2syswsq-ue.a.run.app/auth/validate?accessToken=${user.token}&action=${action}`;
...
async function getUser() {
  const promise = await fetch(`https://bingo-generator-backend-vai2syswsq-ue.a.run.app/music/me?accessToken=${user.token}`);
...
async function getPlaylists() {
  ...
  const response = await fetch(`https://bingo-generator-backend-vai2syswsq-ue.a.run.app/music/playlists?accessToken=${user.token}`);
...
async function getTracks(playlistId) {
  ...
  const response_1 = await fetch(`https://bingo-generator-backend-vai2syswsq-ue.a.run.app/music/tracks?accessToken=${user.token}&playlistId=${playlistId}`);
